    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.content}>
                {news.id === '1' && 'BIGFOOT Esports participou do campeonato Forja do Ornn, realizado em São Paulo, e teve um desempenho impressionante, alcançando as semifinais. A equipe mostrou grande habilidade e trabalho em equipe, destacando-se entre os competidores.'}
                ...
                {news.id === '5' && 'BIGFOOT Esports anunciou uma nova parceria com a empresa XYZ, visando fortalecer a equipe e expandir suas operações. A parceria trará novos recursos e oportunidades para a equipe, permitindo que eles alcancem novos patamares no cenário competitivo.'}
            </Text>
        </View>
    );
};
